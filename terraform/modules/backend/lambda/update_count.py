...
def lambda_handler(event, context):
    try:
        ...
        response = table.get_item(Key={'id': '1'})  # Use the new key name 'PK' and value
        ...
        if 'Item' in response:
            ...
            table.update_item(
                Key={'id': '1'},  # Use the same key for update
            ...
            return {
                ...
                'body': json.dumps({'Views': convert_decimal(updated_count)})
            }
        else:
